...
func (dba *DBAccountsHandlerStub) PrepareAccountsMapDCDT(_ []*data.AccountDCDT, _ data.CountTags, _ uint32, _ uint64) (map[string]*data.AccountInfo, data.TokensHandler) {
	return nil, nil
}
