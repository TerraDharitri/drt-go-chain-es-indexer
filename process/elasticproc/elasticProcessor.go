...
func (ei *elasticProcessor) RemoveAccountsDCDT(shardID uint32, timestampMs uint64) error {
	err := ei.removeFromIndexByTimestampAndShardID(shardID, elasticIndexer.AccountsDCDTIndex, timestampMs)
	if err != nil {
		return err
	}

	return ei.removeFromIndexByTimestampAndShardID(shardID, elasticIndexer.AccountsDCDTHistoryIndex, timestampMs)
}
...
func (ei *elasticProcessor) indexAlteredAccounts(
	...
	return ei.saveAccountsDCDT(accountsToIndexDCDT, updatesNFTsData, buffSlice, tagsCount, shardID, timestampMs)
}
...
func (ei *elasticProcessor) saveAccountsDCDT(
	...
	accountsDCDTMap, tokensData := ei.accountsProc.PrepareAccountsMapDCDT(wrappedAccounts, tagsCount, shardID, timestampMs)
	...
	return ei.saveAccountsDCDTHistory(accountsDCDTMap, buffSlice, shardID, timestampMs)
}
...
func (ei *elasticProcessor) saveAccountsDCDTHistory(accountsInfoMap map[string]*data.AccountInfo, buffSlice *data.BufferSlice, shardID uint32, timestampMs uint64) error {
