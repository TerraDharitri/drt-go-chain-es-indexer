...
type DBAccountHandler interface {
	...
	PrepareAccountsMapDCDT(accounts []*data.AccountDCDT, tagsCount data.CountTags, shardID uint32, timestampMs uint64) (map[string]*data.AccountInfo, data.TokensHandler)
