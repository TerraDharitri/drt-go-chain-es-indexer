...
func TestRelayedV2Disabled(t *testing.T) {
	...
	tx := &transaction.Transaction{
		...
		GasLimit: 15406000,
		GasPrice: 1000000000,
		Data:     []byte("relayedTxV2@a56f37f2356753eb2db8b8fe6dbf026261653973fc08785b69d0406162e16f9d@028e@@cf52df0a6c31738ff283b3dade4e18f1c3029a062eccc22fba5cda8510fc02931d7824abdf1bca7d8c24cc72ddc02af5e060dc99fbde1e531b857b63818ff20a"),
		Value:    big.NewInt(0),
	}
	txInfo := &outport.TxInfo{
		Transaction: tx,
