...
start() {
  ...
  docker run -d --name "${IMAGE_NAME}" -p 127.0.0.1:9200:9200  -p 127.0.0.1:9300:9300 \
...
start_open_search() {
  ...
  docker run -d --name "${IMAGE_OPEN_SEARCH}" -p 127.0.0.1:9200:9200 -p 127.0.0.1:9600:9600 \
